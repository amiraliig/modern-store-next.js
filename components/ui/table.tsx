  ...
  return (
    <tfoot
      ...
      className={cn(
        ...
        "[&_tr]:last:border-b-0",
        "[&_td]:px-2 md:[&_td]:px-4 [&_td]:py-3 md:[&_td]:py-4",
        className
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-2 md:px-4 py-3 md:py-4 align-middle font-semibold text-foreground whitespace-nowrap",
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "px-2 md:px-4 py-3 md:py-4 align-middle",
        "text-xs md:text-sm",
        "break-words",
        "[&:has([role=checkbox])]:pr-0",
        className
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn(
        "mt-4 text-xs md:text-sm text-muted-foreground",
        className
      )}
      {...props}
    />
